...
from algo import create_pipeline
...
def main():
    ...
    train_predictor = create_pipeline.create_predictor('AAPL', train_data_fetcher, train_data_fetcher)
    test_predictor = create_pipeline.create_predictor('AAPL', train_data_fetcher, test_data_fetcher)
    print(train_predictor('AAPL'))
